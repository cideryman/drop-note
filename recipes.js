...
const DEFAULT_RECIPES = [
  ...
  },
  {
    id: "kasuya_neo_brew",
    creator: "테츠 카스야",
    recipeName: "THE NEO BREW · 10푸어",
    baseBeanWeight: 20,
    grindBase: "C40 40–45클릭 · 극굵게",
    grindNote: "표준 클릭 · 공식 레시피 · Red Clix 약 2배",
    grindReferenceType: "official",
    grindSourceLabel: "Tetsu Kasuya 공식 — THE NEO BREW",
    grindSourceUrl: "https://www.youtube.com/watch?v=k0nsShguOsU",
    type: "hot",
    ratioText: "1:15",
    equipment: "Hario V60 NEO",
    equipmentLabel: "NEO",
    variantLabel: "공식 원본",
    isVariant: false,
    sourceLabel: "Tetsu Kasuya 공식 — THE NEO BREW",
    sourceUrl: "https://www.youtube.com/watch?v=k0nsShguOsU",
    recommendedDoseMin: 15,
    recommendedDoseMax: 30,
    isCustom: false,
    stages: [
      { step: 1, name: "1차 주입 (뜸들이기)", action: "pour", water: 30, temp: 96, startSec: 0, pourEndSec: 5, stepEndSec: 30, guideMode: "immediate", switch: "open" },
      { step: 2, name: "2차 주입", action: "pour", water: 30, temp: 96, startSec: 30, pourEndSec: 35, stepEndSec: 45, guideMode: "immediate", switch: "open" },
      { step: 3, name: "3차 주입", action: "pour", water: 30, temp: 96, startSec: 45, pourEndSec: 50, stepEndSec: 60, guideMode: "immediate", switch: "open" },
      { step: 4, name: "4차 주입", action: "pour", water: 30, temp: 96, startSec: 60, pourEndSec: 65, stepEndSec: 75, guideMode: "immediate", switch: "open" },
      { step: 5, name: "5차 주입", action: "pour", water: 30, temp: 96, startSec: 75, pourEndSec: 80, stepEndSec: 90, guideMode: "immediate", switch: "open" },
      { step: 6, name: "6차 주입", action: "pour", water: 30, temp: 96, startSec: 90, pourEndSec: 95, stepEndSec: 105, guideMode: "immediate", switch: "open" },
      { step: 7, name: "7차 주입", action: "pour", water: 30, temp: 96, startSec: 105, pourEndSec: 110, stepEndSec: 120, guideMode: "immediate", switch: "open" },
      { step: 8, name: "8차 주입", action: "pour", water: 30, temp: 96, startSec: 120, pourEndSec: 125, stepEndSec: 135, guideMode: "immediate", switch: "open" },
      { step: 9, name: "9차 주입", action: "pour", water: 30, temp: 96, startSec: 135, pourEndSec: 140, stepEndSec: 150, guideMode: "immediate", switch: "open" },
      { step: 10, name: "10차 주입 및 드로우다운", action: "pour", water: 30, temp: 96, startSec: 150, pourEndSec: 155, stepEndSec: 210, guideMode: "immediate", switch: "open" }
    ]
  },
  {
